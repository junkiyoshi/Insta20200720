...
void ofApp::update() {
	...
	for (int x = -800; x <= 800; x += 800) {

		for (int y = -800; y <= 800; y += 800) {

			this->setRingToMesh(this->face, this->frame, glm::vec3(x, y, 0), 0, 180, 20);
			for (auto radius = 120; radius < 360; radius += 60) {

				this->setRingToMesh(this->face, this->frame, glm::vec3(x, y, 0), radius, 60, 20);
			}
		}
	}
}
